...
const log = (0, debug_1.default)("hardhat:core:util:download");
...
async function download(url, filePath, timeoutMillis = 10000, extraHeaders = {}) {
    ...
    if (response.statusCode >= 200 && response.statusCode <= 299) {
        ...
        await fs_extra_1.default.writeFile(tmpFilePath, responseBuffer);
        log("return")
        return fs_extra_1.default.move(tmpFilePath, filePath, { overwrite: true });
    }
    log("consume text before throwing")
